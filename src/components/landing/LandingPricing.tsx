...
export const LandingPricing = ({
  ...
  const pricingPlans = [{
    ...
    features: ['valid for forever', '1 complete AI interview'],
    popular: false,
    savings: null,
    icon: BookOpen,
    ...
    features: ['valid for forever', '5 complete AI interviews'],
    popular: true,
    savings: 25,
    icon: Users,
    badge: 'Best value'
    ...
    features: ['valid for forever', '10 complete AI interviews'],
    popular: false,
    savings: 70,
    icon: Award,
    badge: 'Maximum prep'
