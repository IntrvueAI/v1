    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          <Input
            placeholder="Search interviews by name, description, or tags..."
            value={searchQuery}
            ...
            >
              <CardHeader>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <Badge 
                    variant="outline" 
                    className={`bg-${INTERVIEW_CATEGORIES[interview.category].color}-50 text-${INTERVIEW_CATEGORIES[interview.category].color}-700 border-${INTERVIEW_CATEGORIES[interview.category].color}-200`}
                  >
                  ...
                  <Badge 
                    variant="outline"
                    className={`bg-${getDifficultyColor(interview.difficultyLevel)}-50 text-${getDifficultyColor(interview.difficultyLevel)}-700 border-${getDifficultyColor(interview.difficultyLevel)}-200`}
                  >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {interview.scoringCriteria.map((criteria, index) => (
